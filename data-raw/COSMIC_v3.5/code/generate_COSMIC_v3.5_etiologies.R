...
tmp.SBS96 <-
  data.table::fread("data-raw/COSMIC_v3.5/data/etiology/COSMIC_v3.5_SBS_proposed_etiology.csv")
...
tmp.DBS78 <-
  data.table::fread("data-raw/COSMIC_v3.5/data/etiology/COSMIC_v3.5_DBS_proposed_etiology.csv")
...
tmp.ID <-
  data.table::fread("data-raw/COSMIC_v3.5/data/etiology/COSMIC_v3.5_ID_proposed_etiology.csv")
sigs.etiologies.ID <-
