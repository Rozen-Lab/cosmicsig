...
tmp.SBS96 <-
  data.table::fread("data-raw/COSMIC_v3.4/data/etiology/COSMIC_v3.4_SBS_proposed_etiology.csv")
...
tmp.DBS78 <-
  data.table::fread("data-raw/COSMIC_v3.4/data/etiology/COSMIC_v3.4_DBS_proposed_etiology.csv")
...
tmp.ID <-
  data.table::fread("data-raw/COSMIC_v3.4/data/etiology/COSMIC_v3.4_ID_proposed_etiology.csv")
sigs.etiologies.ID <-
